...
<%@page import="com.sitas.*"%>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
 <title>SiTaS :: Criando Teste Triangular!!!</title>
 <link rel="stylesheet" type="text/css" href="/sitas/css/sitas-gui.css" />
 <script language="javascript1.2" type="text/javascript" src="/sitas/js/stm31.js" ></script>
  <script language="javascript1.2" type="text/javascript" src="/sitas/js/sitas-teste.triangular.objetivo.js" ></script>
</head>
<body class="body-fundo" onLoad="inicio()">
 <script language="javascript1.2" type="text/javascript" src="/sitas/js/sitas-mainmenu.js" ></script>
 <table width="95%" height="93%" border="0" align="center">
  <tr>
   <td width="60%" align="left" valign="top">
    ...
    <b>Sistema para Testes de An&aacute;lise Sensorial ( SiTaS )</b> <br />
   </td>
   <td width="40%" align="center" valign="middle">
    <img src="/sitas/image/sitas-logog.jpg" width="160" height="54" /> <br />
    <b class="data-hora"><script language="JavaScript1.2" type="text/javascript" src="/sitas/js/sitas-hora.js"></script></b>
   </td>
  </tr>
...
<!-- OBJETIVO -->
     ...
     <table width="85%" border="1" bordercolor="#CCCC00">
      <tr>
       <td>
        <table width="100%" border="0">
         <tr bgcolor="#CCCC00">
           ...
           <table width="100%"  border="0">
            <tr>
             ...
             <td width="5%" height="51" align="center" valign="middle">
              <a href="javascript:chamarPagina(5)" target="mainFrame">
               <img src="/sitas/image/sitas-visualizar.gif" alt="Visualizar testes!!!" width="19" height="19" border="0" />
              </a>
             </td>
            </tr>
           </table>
