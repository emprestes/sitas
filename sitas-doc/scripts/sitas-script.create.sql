...
CREATE TABLE Fone (
 ...
 ALTER TABLE Fone
	...
	CHECK ( character_length(cast(ddd as text)) = 3 ); 
 
 ALTER TABLE Fone
	ADD CONSTRAINT chk_fone_empresa
	CHECK ( character_length(cast(fone as text)) > 5 AND character_length(cast(fone as text)) < 13 );
...
----------------------------------------------------------------  
 ...
 ALTER TABLE Pessoa
	...
	CHECK ( character_length(cast(cep as text)) = 8);
