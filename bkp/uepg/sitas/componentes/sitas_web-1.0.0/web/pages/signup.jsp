...
<ul>
    ...
    <li>
        <sitas_web-1.0.0:label styleClass="desc" key="userForm.username"/>
    ...
    <li>
        <div>
            <div class="left">
                <sitas_web-1.0.0:label styleClass="desc" key="userForm.password"/>
                <html:errors property="password"/>
                <html:password styleClass="text medium" property="password" styleId="password" redisplay="true"/>
            </div>
            <div>
                <sitas_web-1.0.0:label styleClass="desc" key="userForm.confirmPassword"/>
    ...
    <li>
        <sitas_web-1.0.0:label styleClass="desc" key="userForm.passwordHint"/>
    ...
    <li>
        <div>
            <div class="left">
                <sitas_web-1.0.0:label styleClass="desc" key="userForm.firstName"/>
                <html:errors property="firstName"/>
                <html:text styleClass="text medium" property="firstName" styleId="firstName" maxlength="50"/>
            </div>
            <div>
                <sitas_web-1.0.0:label styleClass="desc" key="userForm.lastName"/>
    ...
    <li>
        <div>
            <div class="left">
                <sitas_web-1.0.0:label styleClass="desc" key="userForm.email"/>
                <html:errors property="email"/>
                <html:text styleClass="text medium" property="email" styleId="email"/>
            </div>
            <div>
                <sitas_web-1.0.0:label styleClass="desc" key="userForm.phoneNumber"/>
    ...
    <li>
        <sitas_web-1.0.0:label styleClass="desc" key="userForm.website"/>
    ...
    <li>
        ...
        <div class="group">
            ...
            <div>
                ...
                <p><sitas_web-1.0.0:label key="userForm.addressForm.province"/></p>
            </div>
            <div class="left">
                ...
                <p><sitas_web-1.0.0:label key="userForm.addressForm.postalCode"/></p>
            </div>
            <div>
                <sitas_web-1.0.0:country name="countries" toScope="page"/>
                ...
                <p><sitas_web-1.0.0:label key="userForm.addressForm.country"/></p>
            </div>
        </div>
    </li>
