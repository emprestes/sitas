...
public class UserDaoHibernate extends BaseDaoHibernate implements UserDao, UserDetailsService {
    /**
     * @see br.emprestes.sitas.dao.UserDao#getUser(Long)
     */
    ...
    /**
     * @see br.emprestes.sitas.dao.UserDao#getUsers(br.emprestes.sitas.model.User)
     */
    ...
    /**
     * @see br.emprestes.sitas.dao.UserDao#saveUser(br.emprestes.sitas.model.User)
     */
    ...
    /**
     * @see br.emprestes.sitas.dao.UserDao#removeUser(Long)
     */
