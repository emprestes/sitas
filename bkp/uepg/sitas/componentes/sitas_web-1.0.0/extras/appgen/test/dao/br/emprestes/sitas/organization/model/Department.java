package br.emprestes.sitas.organization.model;

import java.util.Date;

import br.emprestes.sitas.model.BaseObject;
...
public class Department extends BaseObject {
     ...
     * @hibernate.id column="department_id" generator-class="increment" unsaved-value="null"
     */
